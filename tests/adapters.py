...
def run_get_batch(
    ...
    """
    return get_batch(dataset, batch_size=batch_size, context_size=context_length, device=device)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return get_cosine_annealing_learning_rate_schedule(
        t=it,
...
def run_save_checkpoint(
    ...
    """
    save_checkpoint(model=model, optimizer=optimizer, iteration=iteration, dest=out)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    vocab: Vocabulary = train_bpe(input_path, vocab_size, special_tokens)
    return (vocab.token_to_bytes, vocab.merges)
